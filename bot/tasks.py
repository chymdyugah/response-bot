...
def upload_to_ai(questions:list, user_info:str, merchant:str, user_id:int):
    ...
    requests.post("https://api.smartcomplyapp.com/api/compliance/submit_predictions/", data={"predictions": json.dumps(model_predictions), "merchant": merchant, "user": user_id})
    return
